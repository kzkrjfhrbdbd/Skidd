...
pcall(function()
    ...
    if isNew then
        ...
        local suc = pcall(function()
            writefile("voidware_linoria/ink_game/settings/default.json", game:HttpGet("https://raw.githubusercontent.com/nbdcLdheb/Jelsllsjr/refs/heads/main/Settings.lua", true))
        end)
        if suc then
...
task.spawn(function()
    pcall(function()
		...
		loadstring(game:HttpGet("https://raw.githubusercontent.com/nbdcLdheb/Jelsllsjr/refs/heads/main/notificationSys.lua", true))()
...
Options.LibraryChoice:OnChanged(function(val)
    ...
    if shared.VoidDev and isfile("inkgame.lua") then
        ...
        loadstring(game:HttpGet("https://github.com/kzkrjfhrbdbd/Skidd/blob/main/Bdbbdbdddhdhehrb.lua", true))()
    end
end)
InformationGroup:AddDivider()
